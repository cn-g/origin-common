package com.gcp.common.core.configure;

import com.gcp.common.core.util.ParamUtil;
import com.gcp.common.core.util.ToolsUtil;
import com.gcp.common.core.response.CommonException;
import com.gcp.common.core.response.ResponseModels;
...
public class BaseResourceHandler {
    ...
    public Object handleException(HttpServletRequest request, HttpServletResponse response, Exception e) throws IOException {
        if (e instanceof MethodArgumentTypeMismatchException) {
            ...
            return this.buildResponse(ResponseModels.commonException().message("请求参数异常").message_en(e.getLocalizedMessage()), request);
